                    ...
                    <Col xs={24} key={item.id}>
                      <Card style={{ marginBottom: "1px" }}>
                        ...
                        <Row align="middle">
                          ...
                          <Col span={22}>
                            <Typography.Text>Present: {item.attendance_summary.Present}</Typography.Text>
                          </Col>
                        </Row>
                        <Row align="middle">
                          <Col span={2}>
                          ...
                          <Col span={22}>
                            <Typography.Text>Absent: {item.attendance_summary.Absent}</Typography.Text>
                          </Col>
                        </Row>
                        <Row align="middle">
                          <Col span={2}>
                          ...
                          <Col span={22}>
                            <Typography.Text>Leave: {item.attendance_summary.Leave}</Typography.Text>
                          </Col>
                        </Row>
                        <Row align="middle">
                          <Col span={2}>
                          ...
                          <Col span={22}>
                            <Typography.Text>Exempt: {item.attendance_summary.Exempt}</Typography.Text>
                          </Col>
                        </Row>
                        <Row align="middle">
                          <Col span={24}>
                            <Typography.Text>Total: {item.attendance_summary.Total}</Typography.Text>
                          </Col>
                        </Row>
                        <Tooltip title={`${item.attendance_summary.Percent}%`} placement="top" arrow>
                          <Progress
